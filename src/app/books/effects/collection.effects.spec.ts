...
describe('CollectionEffects', () => {
    ...
    describe('loadCollection$', () => {
        it('should return a collection.LoadSuccess, with the books, on success', () => {
            ...
            const completion = new CollectionActions.LoadSuccess([
                book1,
                book2
            ]);
    ...
    describe('addBookToCollection$', () => {
        ...
        describe('removeBookFromCollection$', () => {
            it('should return a collection.RemoveBookSuccess, with the book, on success', () => {
                ...
                const completion = new CollectionActions.RemoveBookSuccess(
                    book1
                );
                ...
                expect(effects.removeBookFromCollection$).toBeObservable(
                    expected
                );
                expect(db.executeWrite).toHaveBeenCalledWith(
                    'books',
                    'delete',
                    [book1.id]
                );
